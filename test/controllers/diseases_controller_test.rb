...
class DiseasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disease" do
    assert_difference("Disease.count") do
      post diseases_url, params: { disease: { code: @disease.code, description: @disease.description, sexo: @disease.sexo } }
    end
  ...
  test "should update disease" do
    patch disease_url(@disease), params: { disease: { code: @disease.code, description: @disease.description, sexo: @disease.sexo } }
