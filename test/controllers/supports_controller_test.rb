...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference("Support.count") do
      post supports_url, params: { support: { diagnosis: @support.diagnosis, event_type: @support.event_type, expiration_date: @support.expiration_date, title: @support.title } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { diagnosis: @support.diagnosis, event_type: @support.event_type, expiration_date: @support.expiration_date, title: @support.title } }
